...
ingerir_nuevos_textos <- function(datos_file,text_file,
                           lexicon_file = "lexicon_espanol.rds",
...
# crudos <- read_csv(datos_file,col_types = c("skip", "skip", "date",
...
# 
# acp_preparacion <- prep(acp_receta,training = datos_acp)


#acp_tidy <- tidy(acp_preparacion,2)

# medias <- acp_preparacion$steps[[1]]$means
# desviaciones <- acp_preparacion$steps[[1]]$sds
